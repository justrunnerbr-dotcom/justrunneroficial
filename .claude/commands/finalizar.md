---
description: Salva o estado atual do projeto Just Runner na memória antes de encerrar a sessão
---

Sessão terminando. Antes de encerrar, atualize a memória do projeto (o arquivo de memória tipo "project" do Just Runner, e um de "feedback" se surgiu alguma preferência nova nesta conversa) com:
...
Lembre-se: nada relacionado a JHF (`C:\Users\Administrador\jhf\justhavefun`) deve ser escrito ou alterado a partir daqui — só a memória e o repositório do Just Runner.
